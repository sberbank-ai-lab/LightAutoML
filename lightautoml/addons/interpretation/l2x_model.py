...
class L2XModel(nn.Module):
    def __init__(self,
        ...
        self.ti_model = TIModel(
            voc_size, embed_dim, conv_filters,
            conv_ksize, drop_rate, hidden_dim,
            weights_matrix, trainable_embeds
