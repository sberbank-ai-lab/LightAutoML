...
class RandomForestSklearn(OptunaTunableMixin, TabularMLAlgo, ImportanceEstimator):
    ...
    def init_params_on_input(self, train_valid_iterator: TrainValidIterator) -> dict:
        ...
        if 'criterion' not in suggested_params:
            suggested_params['criterion'] = 'mse' if task == 'reg' else 'gini'
        ...
        if rows_num > 10000:
            suggested_params['min_samples_leaf'] = 8 if task == 'reg' else 16
        else:
            suggested_params['min_samples_leaf'] = 32 if task == 'reg' else 64
    ...
    def sample_params_values(self, trial: Trial, suggested_params: Dict, estimated_n_trials: int) -> Dict:
        ...
        trial_values['min_samples_leaf'] = trial.suggest_int(
